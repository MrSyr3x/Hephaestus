'use client';
/* eslint-disable @typescript-eslint/no-explicit-any -- canvas particle state is loosely typed by design */
...
function HoleBackground({
  ...
  const tick = React.useCallback(() => {
    ...
    drawParticles(ctx);
    ctx.restore();
    // eslint-disable-next-line react-hooks/immutability -- intentional recursive rAF loop, no React Compiler in this project
    ...
    >
      ...
      <motion.div
        className={cn(
          ...
          'dark:[background:linear-gradient(20deg,#fabd2f,#fe801920_16.5%,#fb4934_33%,#fb493420_49.5%,#fabd2f_66%,#fabd2f60_85.5%,#fe8019_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,#fabd2f,#fe801940_16.5%,#fb4934_33%,#fb493440_49.5%,#fabd2f_66%,#fabd2f80_85.5%,#fe8019_100%)_0_100%_/_100%_200%]',
        )}
