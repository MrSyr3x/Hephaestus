...
export function PricingModal({
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="border-white/8 bg-[#201e1a] p-0 text-white sm:max-w-5xl max-h-[90dvh] overflow-y-auto">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  plan.featured
                    ? "border-[#D97757]/50 bg-[#D97757]/4"
                    : "border-white/12 bg-[#1a1815]",
                )}
              >
                {/* Most popular pill */}
                {plan.featured && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="rounded-full border border-[#D97757]/20 bg-[#1a1815] px-3 py-1 text-[11px] font-medium text-[#DD8967]">
                      Most popular
                    </span>
                  </div>
                )}
                ...
                <div className="mb-1 flex items-center gap-2">
                  ...
                  {isActive && (
                    <span className="rounded-full border border-[#D97757]/20 bg-[#D97757]/10 px-2 py-0.5 text-[10px] font-medium text-[#DD8967]">
                      Active
                    </span>
                  )}
                </div>
                    ...
                    <div key={f} className="flex items-center gap-2.5">
                      <div
                        className={cn(
                          ...
                          plan.featured ? "bg-[#D97757]/15" : "bg-white/8",
                        )}
                      >
                        <Check
                          className={cn(
                            "h-2.5 w-2.5",
                            plan.featured ? "text-[#DD8967]" : "text-white/50",
                          )}
                        />
                      </div>
                    ...
                    >
                      <Button
                        className={cn(
                          ...
                          plan.featured
                            ? "bg-[#D97757] text-white hover:bg-[#DD8967] active:scale-95"
